...
7. **Aucun style inexplicable** : la coquille est un écran du design system comme les autres (14 au 18 sept. 2026 : les pages `atlas/` et `loop/` absorbées — par le Bureau et par le rail NOEMA —, l'accueil réduit à un seuil, la documentation du design system fusionnée en une page) — les parties nouvelles (dock, coquille, rail) entrent dans le système comme patterns, auditées par les 12 familles. L'innovation n'exempte du système pour personne.
