...
console.log('\nACCUEIL SOBRE — entrées expliquées');
{
  ...
  t('aucun lien vers l’ancien écran loop/ ne subsiste (Vague 2)', ![...document.querySelectorAll('a[href]')].some((a) => /^loop\//.test(a.getAttribute('href'))));
  t('menu « + » : lien Boucle NOEMA → le rail NOEMA de Point Zero', [...document.querySelectorAll('#h-plus-menu a')].some((a) => a.getAttribute('href') === 'point-zero/#pz-noema' && a.textContent.includes('Boucle NOEMA')));
